...
SMALL_CACTUS = [pygame.image.load(os.path.join("Images/barrels.png")),
                pygame.image.load(os.path.join("Images/rock_mark.png")),
                pygame.image.load(os.path.join("Images/fence.png"))]
LARGE_CACTUS = [pygame.image.load(os.path.join("Images/LargeCactus1.png")),
                pygame.image.load(os.path.join("Images/tumbleweed.png")),
...
BG = pygame.image.load(os.path.join("Images/mark3.png"))
...
def menu(death_count):
    ...
    while run:
        ...
        if death_count == 0:
            ...
            score = font.render(": " + str(points), True, (0, 0, 0))
